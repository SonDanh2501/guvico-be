...
import { SERVICE_DEFAULT } from '../entity/order.entity'
import { PAYMENT_METHOD, STATUS_ORDER } from '../enum'
...
export class Order extends BaseEntity {
    ...
    @Prop({ type: [{
            ...
            note_block: { type: String, default: null }
        }], default: [] }) // danh sach block moi
    id_block_collaborator_new: Object[]
