...
export class Collaborator extends BaseEntity {
  ...
  @Prop({ default: null }) // Không rõ => để nguyên
  id_inviter: string;
  ...
  @Prop({ default: false }) // Có giấy CMND
  is_identity: boolean;
  ...
  @Prop({ default: false }) // Có giấy sơ yếu lý lịch
  ...
  @Prop({ default: false })
  is_household_book: boolean; // Có sổ hộ khẩu

  @Prop({ default: [] })
  household_book_image: string[];

  @Prop({ default: false })
  is_behaviour: boolean; // Có giấy xác nhận hạnh kiểm
  ...
  @Prop({ default: false }) // Có giấy hồ sơ thỏa thuận hợp tác
  ...
  @Prop({ default: false }) // Trạng thái khóa
  is_locked: boolean;

  @Prop({ default: null })
  date_lock: string;

  @Prop({ default: false }) // Trạng thái liên lạc
  ...
  @Prop({ default: false }) // Trạng thái online trên app
  is_online: boolean;
