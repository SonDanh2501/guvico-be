...
import { PunishTicket } from 'src/@repositories/module/mongodb/@database';
import { Transaction } from 'src/@repositories/module/mongodb/@database/schema/transaction.schema';
